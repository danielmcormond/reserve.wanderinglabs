...
curl -d '{"facilityId":"5112", "baseUrl":"https://washington.goingtocamp.com", "path":"/AlderLake-TacomaPowerPark%2fEast(Sites1-40)%3fCalendar", "concurrency":2}' -H "Content-Type: application/json" -X POST http://192.168.99.100:3003/data


curl -d '{"facilityId":"5112", "baseUrl":"https://washington.goingtocamp.com", "path":"/AlderLake-TacomaPowerPark%2fEast(Sites1-40)%3fCalendar", "concurrency":2}' -H "Content-Type: application/json" -X POST http://204.48.25.66/data
